...
export const ProductList = ({
  ...
  return (
    <div style={{ width: "83%", padding: "0px 20px" }}>
      <Box
      ...
      >
        <Box display="flex" alignItems={"center"} height={"20px"}>
          ...
          >
            <h6>{totalProducts} STYLES FOUND</h6>
          </Box>
          <Box paddingLeft={"10px"}>
            <h6>
              VIEW : PAGE {currentPage} OF{" "}
              {Math.ceil(totalProducts / 12) != 0
            ...
            <Menu>
              ...
              <MenuList minWidth="195px">
                <MenuOptionGroup defaultValue="" type="radio">
                  <MenuItemOption onClick={(e) => changeSort("")} value="">
                    RELEVENCE
                  </MenuItemOption>
                  <MenuItemOption
                    onClick={(e) => changeSort("asc")}
                    value="asc"
                  >
                    LOW TO HIGH
                  </MenuItemOption>
                  <MenuItemOption
                    onClick={(e) => changeSort("desc")}
                    value="desc"
                  >
                    HIGH TO LOW
                  </MenuItemOption>
