...
function PaymentGateway() {
    ...
    let [DeleteData, setDeleteData]  =useState();
            async function deleteData(){
              ...
              let fetch1 = await fetch("https://black-cormorant-hat.cyclic.app/cart")
              let data = await fetch1.json();
              // console.log(data);
              let uniqueIDArr = [];
              let uniqueIDObj = {};
                  data.forEach(function (ele) { 
                      uniqueIDObj[ele._id] = (uniqueIDObj[ele._id] || 0) + 1; 
                 });
              ...
              uniqueIDArr.map((ele)=>{
                  fetch (`https://black-cormorant-hat.cyclic.app/cart/${ele.id}`,{
                  method : "DELETE",
              })
              })
            }
